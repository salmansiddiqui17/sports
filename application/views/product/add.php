<div class="container">
  ...
  <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo base_url()?>product/save" method="post" enctype="multipart/formdata">
              <div class="box-body">
              ...
              <div class="box-footer">
                ...
                <input type="submit" name="save" class="btn btn-primary pull-left col-md-offset-2">
              </div>
              <!-- /.box-footer -->
            </form>
          </div>

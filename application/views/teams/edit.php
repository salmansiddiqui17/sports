      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box col-sm-3">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                <form class="form-horizontal form-label-left" action="<?php echo $base_url; ?>teams/update" method="post">
                    <input name="id" value="<?php echo $team['id']; ?>" type="hidden">
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" value="<?= $team['name'] ?>" name="name" placeholder="Like: Lahore Qalanders" required="required" type="text">
                        </div>
                      </div>
                          ...
                          <select id="players" class="form-control col-md-7 col-xs-12" name="players[]" multiple required="required">
                            <?php
                                foreach ($players as $key => $player) {
                                  echo "<option value='$player[id]' ".(in_array($player['id'],explode(',',$team['players']))?"selected":"").">$player[name]</option>";
                                }  
                            ?>
                          </select>
                        </div>
